...
ax1=axes[0]
ax2=axes[1]
ax1.plot(fdm_x,fdm_wlan,color='#FE0000',linestyle=':',marker='x',markersize=3,label='FDM_WLAN')
ax1.plot(fdm_x,fdm_sat,color='#27BAFF',linestyle=':',marker='o',markersize=3,label='FDM_SAT')
